...
<script type="text/javascript">
    function edit(id,nama){
        $("#propinsiID").val(id);
        $("#propinsiNama").val(nama);
        $("#myform").attr("action","<?php echo site_url($activeModule.'_provinsi/update'); ?>");
    }
    ...
    <div class="span12">
        <div class="box">
            ...
            <div class="box-content">
                ...
                <!-- FORMS  -->
                <form id="myform" class="form-horizontal" method="post" action="<?php echo site_url($activeModule.'_provinsi/'.$mode); ?>">
                    <div class="control-group">
                        <label class="control-label" for="basicround">Nama Propinsi</label>
                        <div class="controls">
                            <input type="hidden" id="propinsiID" name="propinsiID"/>
                            <input type="text" class="input-square" id="propinsiNama" name="propinsiNama"/>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="span12">
